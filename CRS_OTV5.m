%% Multi-Criteria based Common Rating weight Similarity approach (MCCRS)
...
for train_test=.60:.10:.90
    ...
    total5x_recall(y,:)= (round((sum(recall)./sum(recall ~=0))*10000))/10000;
...
gap=[0,0,0,0,0,0,0];
Grand_result = [total1_coverage; gap; total2_MAE;gap;total3_RMSE; gap;total4_precision;gap; total5x_recall;gap;total6_fm;gap;total7_accuracy;gap;total8_correct];
